...
import { NestedEnumPublishStatusNullableWithAggregatesFilter } from './nested-enum-publish-status-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumPublishStatusNullableFilter } from './nested-enum-publish-status-nullable-filter.input';

@InputType()
export class EnumPublishStatusNullableWithAggregatesFilter {

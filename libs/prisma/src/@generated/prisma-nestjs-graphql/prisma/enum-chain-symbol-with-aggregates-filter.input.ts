...
import { NestedEnumChainSymbolWithAggregatesFilter } from './nested-enum-chain-symbol-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumChainSymbolFilter } from './nested-enum-chain-symbol-filter.input';

@InputType()
export class EnumChainSymbolWithAggregatesFilter {

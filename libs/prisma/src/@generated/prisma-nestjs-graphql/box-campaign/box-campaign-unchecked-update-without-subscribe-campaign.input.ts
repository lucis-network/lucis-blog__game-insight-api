...
import { BoxCampaignBuyHistoryUncheckedUpdateManyWithoutBoxInput } from '../box-campaign-buy-history/box-campaign-buy-history-unchecked-update-many-without-box.input';

@InputType()
export class BoxCampaignUncheckedUpdateWithoutSubscribeCampaignInput {
    ...
    @Field(() => BoxCampaignBuyHistoryUncheckedUpdateManyWithoutBoxInput, {nullable:true})
    buyHistory?: BoxCampaignBuyHistoryUncheckedUpdateManyWithoutBoxInput;

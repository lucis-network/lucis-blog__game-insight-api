...
import { BoxCampaignSubscribesCreateNestedManyWithoutBox_campaignInput } from '../box-campaign-subscribes/box-campaign-subscribes-create-nested-many-without-box-campaign.input';
...
@InputType()
export class BoxCampaignCreateWithoutWhitelistsInput {
    ...
    @Field(() => BoxCampaignSubscribesCreateNestedManyWithoutBox_campaignInput, {nullable:true})
    subscribeCampaign?: BoxCampaignSubscribesCreateNestedManyWithoutBox_campaignInput;

...
import { BoxCampaignUpdateOneRequiredWithoutBuyHistoryInput } from '../box-campaign/box-campaign-update-one-required-without-buy-history.input';

@InputType()
export class BoxCampaignBuyHistoryUpdateInput {
    ...
    @Field(() => BoxCampaignUpdateOneRequiredWithoutBuyHistoryInput, {nullable:true})
    box?: BoxCampaignUpdateOneRequiredWithoutBuyHistoryInput;
}

...
import { GameUpdateOneRequiredWithoutGame_statisticsInput } from '../game/game-update-one-required-without-game-statistics.input';
import { CurrencyUpdateOneRequiredWithoutGame_statisticInput } from '../currency/currency-update-one-required-without-game-statistic.input';
import { DateTimeFieldUpdateOperationsInput } from '../prisma/date-time-field-update-operations.input';

@InputType()
export class GameStatisticsUpdateInput {
    ...
    @Field(() => GameUpdateOneRequiredWithoutGame_statisticsInput, {nullable:true})
    game?: GameUpdateOneRequiredWithoutGame_statisticsInput;

    @Field(() => CurrencyUpdateOneRequiredWithoutGame_statisticInput, {nullable:true})
    currency?: CurrencyUpdateOneRequiredWithoutGame_statisticInput;

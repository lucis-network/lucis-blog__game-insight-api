...
import { GameCreateNestedOneWithoutGame_currenciesInput } from '../game/game-create-nested-one-without-game-currencies.input';
...
@InputType()
export class GameStatisticsCreateInput {
    ...
    @Field(() => GameCreateNestedOneWithoutGame_currenciesInput, {nullable:false})
    game!: GameCreateNestedOneWithoutGame_currenciesInput;

...
import { ChainUpdateOneRequiredWithoutNftBoxInput } from '../chain/chain-update-one-required-without-nft-box.input';

@InputType()
export class BoxContractUpdateWithoutBoxPricesInput {
    ...
    @Field(() => ChainUpdateOneRequiredWithoutNftBoxInput, {nullable:true})
